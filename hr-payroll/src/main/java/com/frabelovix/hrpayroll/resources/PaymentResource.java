package com.frabelovix.hrpayroll.resources;
...
import com.frabelovix.hrpayroll.serivces.PaymentService;
...
public class PaymentResource {
	...
	public ResponseEntity<Payment> getPaymentAlternative(Long workerId, 
			Integer days){	
		Payment payment = new Payment("Falha Serviço Worker", 0.0, days);		
